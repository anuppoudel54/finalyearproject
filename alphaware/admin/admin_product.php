...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="Watchs"></td>
							</tr>
						</table>
					</center>
				</div>
			...
			if (isset($_POST['add']))
				{
					...
					$qty = $_POST['qty'];
					$code = uniqid('pp_',true);     //rand(0,98987787866533499);
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Watchs</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Photo Frame</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Ornaments</a></li>
				</ul>
			</li>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Watchs</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `product` WHERE category='Watchs' ORDER BY product_id DESC") or die(mysqli_error());
