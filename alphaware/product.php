...
<div id="container">
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php" class="active" style="color:#111;">Watchs</a></li>
			<li>|</li>
			<li><a href="football.php">Photo Frame</a></li>
			<li>|</li>
			<li><a href="running.php">Ornaments</a></li>
		</ul>
	...
	<div id="content">
		...
		<div id="product">
			...
			include ('function/addcart.php');
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='Watchs' ORDER BY product_id DESC") or die (mysqli_error($conn));
